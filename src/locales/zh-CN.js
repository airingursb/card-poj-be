export default {
  ...
  'menu.task.tasklisttodo': '待审列表（标准网点）',
  'menu.task.tasklisttodopro': '待审列表（黄色风暴）',
  'menu.task.tasklisttodothousand': '待审列表（万元户黄色风暴网点）',
  'menu.task.tasklisttodosliver': '待审列表（银牌合作伙伴）',
  'menu.task.tasklisttodogolden': '待审列表（金牌合作伙伴）',
  'menu.task.tasklisttodopartner': '待审列表（战略联盟合作伙伴）',
  'menu.task.tasklistok': '审核列表（完成）',
